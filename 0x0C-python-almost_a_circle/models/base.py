...
"""Module for defining class that serve as base of all classes"""
import json
import csv
import turtle
import tkinter
...
class Base:
    """Base class.
        ...
        __nb_object (int): for calculating instantiated Bases.   
    """
    ...
    def create(cls, **dictionary):
        """instantied from a dictionary of attributes.
    ...
    def load_from_file_csv(cls):
        """classes instantiated from a CSV file.
